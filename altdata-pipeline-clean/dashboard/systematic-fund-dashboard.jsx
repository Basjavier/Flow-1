          ...
          <div style={{ flex: 1, overflowY: "auto", padding: 20 }}>
            ...
            <div style={{ background: "#0a0a0a", border: "1px solid #1a1a1a",
              ...
              <div style={{ display: "grid",
                gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
                {[
                  { name: "CMF Hechos Esenciales", status: "LIVE",
                    last: "hace 12 min", count: 5, color: "#00ff88" },
                  { name: "BCCh Macro Series", status: "LIVE",
                    last: "hace 2h", count: 7, color: "#00ff88" },
                  { name: "Portal Inmobiliario", status: "DEMO",
                    last: "modo demo", count: 20, color: "#ffbb00" },
                  { name: "BCS Volumen", status: "PENDING",
                    last: "en construcción", count: 0, color: "#444" },
                  { name: "Job Postings", status: "PENDING",
                    last: "en construcción", count: 0, color: "#444" },
                  { name: "Diario Oficial NLP", status: "PENDING",
                    last: "en construcción", count: 0, color: "#444" },
                ].map(src => (
