...
// Si abris el archivo suelto (file://) pega contra localhost:8003. Si lo servis
// desde la API (http://host:puerto/dashboard/) usa mismo origen y no hace falta
// CORS. Override siempre con ?api=http://host:puerto
const API_BASE =
  new URLSearchParams(window.location.search).get("api") ||
  (window.location.protocol === "file:" ? "http://localhost:8003" : "");
